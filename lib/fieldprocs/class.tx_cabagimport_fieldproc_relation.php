 ...
 */
class  tx_cabagimport_fieldproc_relation implements tx_cabagimport_ifieldproc  {
	...
	*/
	function main($stackPartConf=false, $object_handler) {
		...
		$relatedRecordWhere = $this->conf['relationfield']." = '".$this->objectHandler->currentFieldValue."' ";
		...
		$relatedRecord = t3lib_BEfunc::getRecordRaw($this->conf['relationtable'], $relatedRecordWhere);
