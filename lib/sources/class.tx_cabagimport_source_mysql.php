 ...
 */
class  tx_cabagimport_source_mysql implements tx_cabagimport_isource {
	...
	*/
	function open($dryRun, $conf, $tx_cabagimport_handler) {
		...
		// debug
		if($TYPO3_CONF_VARS['SYS']['enable_DLOG']) t3lib_div::devLog('connected to mysql host/db', 'cabag_import', -1, array('conf' => $this->conf));
	}
