...
require_once(t3lib_extMgm::extPath('cabag_import').'lib/sources/class.tx_cabagimport_source_file.php');
 ...
 */
class  tx_cabagimport_source_xls extends tx_cabagimport_source_file {
	...
	*/
	function checkConfiguration() {
		...
		// devlog
		if($TYPO3_CONF_VARS['SYS']['enable_DLOG']) t3lib_div::devLog('convert xls', 'cabag_import', -1, array($command, $out, $this->conf['filePath'], file_exists($this->conf['filePath'])));
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/cabag_import/lib/sources/class.tx_cabagimport_source_xls.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/cabag_import/lib/sources/class.tx_cabagimport_source_xls.php']);
}
?>
